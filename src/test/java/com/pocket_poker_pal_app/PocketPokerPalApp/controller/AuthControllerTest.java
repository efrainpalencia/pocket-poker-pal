...
import com.pocket_poker_pal_app.PocketPokerPalApp.service.UserService;
...
class AuthControllerTest {
    ...
    void registerClient_success() throws Exception {
        ...
        clientUser.setEmail(registerRequest.getEmail());
        clientUser.setUsername(registerRequest.getUsername());

        when(userServiceImpl.emailExists(registerRequest.getEmail())).thenReturn(false);
        when(userServiceImpl.usernameExists(registerRequest.getUsername())).thenReturn(false);
    ...
    void resendVerification_success() throws Exception {
        ...
        when(userServiceImpl.findUserByEmail(registerRequest.getEmail())).thenAnswer(invocation -> Optional.of(clientUser));
